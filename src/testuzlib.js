...
console.log('Inside node_modules: fflate exports:', Object.keys(fflate))
console.log('unzlibSync:', fflate.unzlibSync)
console.log('gunzipSync:', fflate.gunzipSync)
